...
/**
 * ClothMeasurement Model
 * 
 * This is a modern wrapper around the existing cloth_m table
 * providing a cleaner interface and additional functionality.
 */
class ClothMeasurement extends Model
{
    ...
    // Attribute mappings for cleaner API
    protected $appends = [
        'customer_id',
        'order_date',
        'receive_date',
    ...
    public function setSleeveAttribute($value)
    {
        $this->Sleeve = $value;
    }
    ...
    public function setShoulderAttribute($value)
    {
        $this->Shoulder = $value;
    }
    ...
    public function setCollarAttribute($value)
    {
        $this->Collar = $value;
    }

    public function getArmpitAttribute()
    {
        return $this->Armpit;
    }

    public function setArmpitAttribute($value)
    {
        $this->Armpit = $value;
    }
    ...
    public function setSkirtAttribute($value)
    {
        $this->Skirt = $value;
    }

    public function getTrousersAttribute()
    {
        return $this->Trousers;
    }

    public function setTrousersAttribute($value)
    {
        $this->Trousers = $value;
    }

    public function getKaffAttribute()
    {
        return $this->Kaff;
    }

    public function setKaffAttribute($value)
    {
        $this->Kaff = $value;
    }

    public function getPachaAttribute()
    {
        return $this->Pacha;
    }

    public function setPachaAttribute($value)
    {
        $this->Pacha = $value;
    }

    public function getKalarAttribute()
    {
        return $this->Kalar;
    }

    public function setKalarAttribute($value)
    {
        $this->Kalar = $value;
    }

    public function getShalwarAttribute()
    {
        return $this->Shalwar;
    }

    public function setShalwarAttribute($value)
    {
        $this->Shalwar = $value;
    }

    public function getYakhanAttribute()
    {
        return $this->Yakhan;
    }

    public function setYakhanAttribute($value)
    {
        $this->Yakhan = $value;
    }

    public function getDamanAttribute()
    {
        return $this->Daman;
    }

    public function setDamanAttribute($value)
    {
        $this->Daman = $value;
    }

    public function getJebAttribute()
    {
        return $this->Jeb;
    }

    public function setJebAttribute($value)
    {
        $this->Jeb = $value;
    }
    ...
    /**
     * Create a new measurement with clean attribute names
     */
    public static function createMeasurement(array $attributes)
    {
        $mapped = [];
        
        // Map clean attribute names to database column names
        $attributeMap = [
            'customer_id' => 'F_cus_id',
            'order_date' => 'O_date',
            'receive_date' => 'R_date',
            'height' => 'Height',
            'sleeve' => 'Sleeve',
