    ...
    <div class="mb-6 bg-yellow-50 border border-yellow-200 rounded-xl p-4">
        <div class="flex items-center">
            ...
            <div class="ml-3">
                ...
                <p class="text-sm text-yellow-700">Pending Customers: {{ $pendingCustomers->count() ?? 0 }}</p>
                <p class="text-sm text-yellow-700">Complete Customers: {{ $completeCustomers->count() ?? 0 }}</p>
            </div>
        </div>
    </div>
    @endif
