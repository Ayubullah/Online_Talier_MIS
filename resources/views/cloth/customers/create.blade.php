...
@section('title', 'Add New Tailoring Order')
            ...
            <div class="bg-white rounded-3xl shadow-2xl overflow-hidden border border-white/20">
                ...
                <div>
                    ...
                    <div>
                                ...
                                <input type="text" id="jeb-input" name="Jeb[]" class="w-full px-3 py-2 border border-gray-300 rounded-md focus:ring-2 focus:ring-emerald-500 focus:border-emerald-500 transition-all duration-200 text-sm bg-white hover:bg-gray-50 mb-2" placeholder="{{ __('Selected jeb types') }}">
                            ...
                            <div class="bg-blue-100 backdrop-blur-md rounded-xl p-4 shadow-inner border border-gray-200">
                                ...
                                <div class="">
                                    ...
                                    <input type="date" name="Order_date[]" class="w-full px-3 py-2 border border-gray-300 rounded-md focus:ring-2 focus:ring-emerald-500 focus:border-emerald-500 transition-all duration-200 text-sm bg-white/80 hover:bg-gray-50" required>
                    </div>
                    ...
                    <div>
                                    ...
                                    <input type="date" name="Receive_date[]" class="w-full px-3 py-2 border border-gray-300 rounded-md focus:ring-2 focus:ring-emerald-500 focus:border-emerald-500 transition-all duration-200 text-sm bg-white/80 hover:bg-gray-50" required>
                                </div>
                                ...
                                <div class="flex flex-col sm:flex-row gap-3 mt-4">
                                    ...
                                    <div class="flex-1">
                                        ...
                                        <input type="number" name="Rate[]" class="w-full px-3 py-2 border border-gray-300 rounded-md focus:ring-2 focus:ring-emerald-500 focus:border-emerald-500 transition-all duration-200 text-sm bg-white/80 hover:bg-gray-50" placeholder="{{ __('rate') }}">
                                    </div>
